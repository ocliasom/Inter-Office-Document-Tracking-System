...
Public Class AdminUserLogs
    ...
    Private Sub AdminUserLogs_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            connection.Open()
            Dim Query As String
            Query = "SELECT `datetime`,`cts`,`action`,`remark` FROM `user_logs`"
